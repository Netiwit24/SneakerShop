...
<div id="app">
  <div class="containers">
    <div class="" style="margin-top:20px">
      <img class="pageBanner" src="./assets/ban.jpg">
    </div>
    ...
    <div class="row" style="margin-top:10px">
      <div class="col-9" v-if="productFire">
        ...
        <ul>
          <li class="col-3" v-for="product in productFire" :key="product['.key']">
            ...
            <p class="price"/><h5>{{product.price}}Bath</h5>
      ...
      <div class="col-3" style="text-align: center;margin-top:6px">
...
let config = {
  apiKey: 'AIzaSyDs3rBTwrzsvTMvxOHoVknYgoOxbDDwbn8',
  authDomain: 'testfirebase-724ed.firebaseapp.com',
  databaseURL: 'https://testfirebase-724ed.firebaseio.com',
  projectId: 'testfirebase-724ed"',
  storageBucket: 'testfirebase-724ed.appspot.com',
  messagingSenderId: '1043981896519'
}
